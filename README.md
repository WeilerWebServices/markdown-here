...
To discover what can be done with Markdown in *Markdown Here*, check out the [Markdown Here Cheatsheet](https://www.markdownguide.org/cheat-sheet/) or in [wiki pages](https://github.com/adam-p/markdown-here/wiki).
...
1. Clone this repo.
```bash
git clone https://github.com/WeilerWebServices/markdown-here.git
```
...
![screenshot of selection conversion](store-assets/markdown-here-image2.gimp.png)
...
![screenshot of options](store-assets/markdown-here-chrome-options-1.gimp.png)
...
See the [Troubleshooting wiki page](wiki/Troubleshooting.md).
...
See the [Compatibility wiki page](wiki/Compatibility.md).
...
* *Markdown Here* uses [Github Flavored Markdown](http://github.github.com/github-flavored-markdown/), with the limitation that GFM special links are not supported nor will they be, as MDH is not Github-specific.
...
* For more tweaky features, visit the [Tips and Tricks](wiki/Tips-and-Tricks.md) section.
